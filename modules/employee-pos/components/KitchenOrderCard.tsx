  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between gap-3 sm:gap-4 min-h-0">
        <div className="flex-1 overflow-y-auto pr-1 sm:pr-1.5 flex flex-col gap-2.5">
      ...
      {/* ── Ticket Footer ── */}
      <div className="px-3 sm:px-4 py-2.5 sm:py-3 bg-neutral-50/50 border-t border-neutral-100 flex flex-col gap-1.5 sm:gap-2 text-[10.5px] sm:text-[11px] shrink-0">
